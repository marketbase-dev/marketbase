...
| **`campaign:`** | Campaign / source bucket — which engagement story they're part of | `campaign:engaged_with_mythos_a` |
...
| `campaign:engaged_with_mythos_a` | Engaged with Anthropic Northwind content, segment A |
| `campaign:engaged_with_mythos_b` | Engaged with Anthropic Northwind content, segment B |
